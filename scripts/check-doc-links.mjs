...
// digests (README/CLAUDE/AGENTS), and the code tree (plugin/librarian/schema/plugins/scripts/kits).
...
const EXCLUDE_PREFIX = ["_meta/", ".claude/", "plugin/node_modules/", "librarian/vendor/"];
