...
SKILLS_MISSING=0
for skill in \
  "plugins/desk-persona/skills/desk-setup/SKILL.md" \
  "plugins/desk-persona/skills/conventions-standard/SKILL.md" \
  "plugins/desk-persona/skills/harvest-loop/SKILL.md" \
  "plugins/desk-persona/skills/brownfield-adoption/SKILL.md" \
