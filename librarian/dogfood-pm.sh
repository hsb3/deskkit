#!/bin/bash
# dogfood-pm.sh — manual dogfood gate for the PM module (`deskkit pm`, feature-gated behind
...
#
# Usage: bash librarian/dogfood-pm.sh   (from anywhere; it cd's to its own directory)
#        DESKKIT_BIN=/path/to/deskkit bash librarian/dogfood-pm.sh   (skip the build)
#
