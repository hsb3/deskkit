...
//
// The six core functions live one-per-file (spec §2.8): sweep.go, patrol.go, propose_fix.go,
// apply_fix.go, restore.go, query.go. Each is the SINGLE implementation both the CLI
