#!/bin/bash
# dogfood-agent.sh — Manual dogfood gate for the REAL deskkit agent loop (`deskkit agent`,
...
# PASS/FAIL, throwaway-mktemp-desk style of verify.sh and dogfood-pm.sh.
#
...
#
# Usage: bash librarian/dogfood-agent.sh
#        DESKKIT_BIN=/path/to/deskkit bash librarian/dogfood-agent.sh   (skip the build)
#
